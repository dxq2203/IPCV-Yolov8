...
class ViewTranformer():
    def __init__(self):
        # Base on the real one 105 meter x 68 meter
        court_width = 68
        court_length = 23.32
        ...
        self.perspective_transformeer = cv2.getPerspectiveTransform(self.pixel_verticies, self.target_verticies)
    ...
    def transform_point(self, point):
        ...
        transform_point = cv2.perspectiveTransform(reshape_point, self.perspective_transformeer)
